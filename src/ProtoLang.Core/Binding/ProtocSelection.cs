...
/// <c>PROTOLANG_PROTOC</c> has a typo in it sees a protoc found on <c>PATH</c> and no indication
...
public enum ProtocSource
{
    ...
    /// <summary>The <c>PROTOLANG_PROTOC</c> environment variable named it.</summary>
    EnvironmentVariable,
