...
/// </param>
/// <param name="RelativePath">The import path as written in the ProtoCross source.</param>
    ...
    IReadOnlyList<string> TestSourceFileNames)
{
    ...
    /// <c>import proto</c> declarations, because those name only what the ProtoCross file imported
