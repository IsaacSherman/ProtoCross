...
/// <summary>
/// What a piece of ProtoCross source calls itself: the label its diagnostics carry, and the
...
/// <c>protocross.config.xml</c> discovery walks up from, and the directory appended to the import
...
/// <summary>
/// A unit of ProtoCross source: the text, and what that text calls itself.
/// </summary>
/// <remarks>
