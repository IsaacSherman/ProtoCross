...
/// <summary>
/// A range in a ProtoCross source file. Spec 22.2 requires the IR to preserve source locations, so
...
public readonly record struct SourceSpan
{
    ...
    /// <summary>Formats as <c>file.pcross:line:column</c> per the spec 26 template.</summary>
