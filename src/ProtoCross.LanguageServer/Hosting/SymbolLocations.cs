...
/// <c>.proto</c> and written in a ProtoCross buffer -- so a list of references is a list about this
...
internal static class SymbolLocations
{
    ...
    /// <remarks>
    /// The ProtoCross side first, because it is the side with no reason to fail: a declaration this
    ...
    /// <summary>Which document a ProtoCross span is in, as the client spells documents.</summary>
    /// <remarks>
    /// <para>
