...
/// </summary>
/// <remarks>
/// More than one document, because a ProtoCross compilation can be wrong about a file that is not the
...
/// compilation</em>, and the two do not line up once a <c>.proto</c> can be blamed. Two ProtoCross
