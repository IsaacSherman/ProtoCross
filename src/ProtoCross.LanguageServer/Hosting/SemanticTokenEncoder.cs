...
/// </para>
/// <para>
/// The one shape the encoding will not carry is a token that crosses a line, and ProtoCross has
...
public static class SemanticTokenEncoder
{
    ...
    /// carries one ProtoCross source today, so every reference in the sequence is a reference written
