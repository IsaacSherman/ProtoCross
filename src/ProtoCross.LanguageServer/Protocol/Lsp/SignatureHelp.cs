...
/// <remarks>
/// <para>
/// A list, an index into it, and an index into that signature's parameters. ProtoCross has no
...
/// because ProtoCross lets a method declare one parameter name twice and a client told to find
