...
public sealed class CSharpBackend : ITestProjectScaffold
{
        ...
        DiagnosticBag diagnostics)
    {
        ...
        {
            var className = ToIdentifier(sourceName) + "ProtoCrossTests";
    ...
    private static void WriteHeader(SourceWriter writer, BackendOptions options)
    {
        ...
        writer.WriteLine();
        writer.WriteLine("// A ProtoCross comparison is emitted exactly as written, including 'x != x', which is");
        ...
        string sourceName)
    {
        ...
        using var scope = writer.Block("internal static void RunRequestedProtoCrossFailTest()");
