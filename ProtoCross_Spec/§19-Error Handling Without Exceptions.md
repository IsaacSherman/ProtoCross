...
ProtoCross has no exceptions. The implemented failure model is:
...
- Does ProtoCross define a built-in `Result` type? `I think we should- it doesn't have to be used, but it should be there for ease of use. ~IS`
