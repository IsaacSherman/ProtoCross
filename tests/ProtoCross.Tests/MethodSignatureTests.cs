...
public class MethodSignatureTests
{
    ...
    public void TheMethodsOnAReceiverComeBackInTheOrderTheyWereDeclared()
    {
        ...
        Assert.Equal(
            ["first", "second", "third"],
            module.MethodsOn("protocross.tests.Outer").Select(method => method.Name));
    }
    ...
    public void AReceiverThisFileNeverExtendedHasNoMethods()
    {
        ...
        Assert.Empty(module.MethodsOn("protocross.tests.Outer.Inner"));
        Assert.Empty(module.MethodsOn("protocross.tests.NoSuchMessage"));
    }
    ...
    public void AReceiverNameDifferingOnlyInCaseIsADifferentReceiver()
    {
        ...
        Assert.Single(module.MethodsOn("protocross.tests.Outer"));
        Assert.Empty(module.MethodsOn("protocross.tests.outer"));
    }
}
