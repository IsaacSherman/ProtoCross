...
public class ProcessSupervisionTests
{
    ...
    {
        var directory = WriteSchema();
        var source = Path.Combine(directory, "read.pcross");
        ...
        var expired = Assert.Single(result.Diagnostics, diagnostic => diagnostic.Code == "PC0083");
        ...
        Assert.DoesNotContain(result.Diagnostics, diagnostic => diagnostic.Code == "PC0003");
    }
    ...
    public void ASchemaProtocRejectsIsStillReportedAsAFailedLoad()
    {
        ...
        Assert.Contains(result.Diagnostics, diagnostic => diagnostic.Code == "PC0003");
        Assert.DoesNotContain(result.Diagnostics, diagnostic => diagnostic.Code == "PC0083");
