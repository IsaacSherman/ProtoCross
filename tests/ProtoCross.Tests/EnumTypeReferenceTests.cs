...
public class EnumTypeReferenceTests
{
    ...
    public void ResolvesATopLevelEnumInAVariableDeclaration()
    {
        ...
        Assert.Equal("protocross.tests.TopLevelStatus", type.Descriptor.FullName);
    }
    ...
    public void ResolvesATopLevelEnumByItsFullyQualifiedName()
    {
        var result = Compile(
            ...
            extend Outer {
                fn f() -> int64 {
                    var s: protocross.tests.TopLevelStatus = status;
                    return count;
                }
            }
            """);
    ...
    public void ResolvesAnEnumNestedInAMessageBySimpleName()
    {
        ...
        Assert.Equal("protocross.tests.Outer.Nested", type.Descriptor.FullName);
    }
    ...
    public void ResolvesAnEnumNestedInAMessageByFullName()
    {
        var result = Compile(
            ...
            extend Outer {
                fn f() -> int64 {
                    var n: protocross.tests.Outer.Nested = nested;
                    return count;
                }
            }
            """);
    ...
    public void ResolvesADeeplyNestedEnum()
    {
        ...
        Assert.Equal("protocross.tests.Outer.Inner.Deep", type.Descriptor.FullName);
    }
    ...
    public void RejectsAnUnknownTypeName()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0025");
    }
    ...
    public void ResolvesAnAmbiguousSimpleNameWhenQualified()
    {
        var result = Compile(
            ...
            """
            extend First {
                fn f() -> protocross.tests.ambiguous.First.Kind {
                    return kind;
                }
            }
            """);
