...
public class SchemaDeclarationTests
{
    ...
    /// <summary>
    /// A local is declared in a ProtoCross buffer, and the schema side of the question has to say so
    ...
    public void AnIdentityNoSchemaDeclaresAnswersNothing()
    {
        ...
        var local = SymbolId.ForDeclaration(
            SymbolKind.Local,
            SourceIdentity.FromPath("buffer.pcross"),
            SourceSpan.SingleLine("buffer.pcross", 0, 1, 1, 5));
