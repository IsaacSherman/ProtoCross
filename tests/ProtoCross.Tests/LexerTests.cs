...
public class LexerTests
{
    private static List<Token> Tokenize(string text, out DiagnosticBag diagnostics)
    {
        ...
        return new Lexer(text, "test.pcross", diagnostics).Tokenize();
    }
    ...
    private static IReadOnlyList<Comment> Comments(string text, out DiagnosticBag diagnostics)
    {
        ...
        var lexer = new Lexer(text, "test.pcross", diagnostics);
        lexer.Tokenize();
    ...
    public void ReportsUnterminatedString()
    {
        ...
        Assert.Contains(diagnostics, d => d.Code == "PC0008");
    }
    ...
    public void ReportsUnterminatedBlockComment()
    {
        ...
        Assert.Contains(diagnostics, d => d.Code == "PC0004");
    }
    ...
    public void ReportsIntegerLiteralOutOfRange()
    {
        ...
        Assert.Contains(diagnostics, d => d.Code == "PC0006");
    }
    ...
    public void AnUnterminatedBlockCommentIsReportedOverItsOpeningDelimiter()
    {
        ...
        var span = Assert.Single(diagnostics, d => d.Code == "PC0004").Span;
    ...
    public void AnUnrecognizedEscapeIsReportedOverTheBackslashAndWhatItEscapes()
    {
        ...
        var span = Assert.Single(diagnostics, d => d.Code == "PC0007").Span;
    ...
    public void ABackslashAtTheEndOfALineDoesNotCarryTheLiteralOntoTheNextOne(string lineEnding)
    {
        ...
        // The literal stops at the line ending, which is what PC0008 already says is the rule.
        ...
        Assert.Contains(diagnostics, d => d.Code == "PC0008");
        Assert.DoesNotContain(diagnostics, d => d.Code == "PC0007");
    ...
    public void AnUnterminatedBlockCommentIsRecordedToTheEndOfTheText()
    {
        ...
        Assert.Contains(diagnostics, diagnostic => diagnostic.Code == "PC0004");
