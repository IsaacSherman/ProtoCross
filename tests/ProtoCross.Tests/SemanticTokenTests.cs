...
public class SemanticTokenTests
{
    ...
    private static List<PaintedToken> Paint(string text)
        => PaintedToken.Decode(SemanticTokenEncoder.Encode(text, "test.pcross").Data);
    ...
    public void TokensArriveInOrderSoTheDeltasAreNeverNegative()
    {
        ...
        var data = SemanticTokenEncoder.Encode(Source, "test.pcross").Data;
    ...
    public async Task ADocumentThatIsNotOpenIsAnsweredWithNoTokensRatherThanAnError()
    {
        ...
        var answer = await client.RequestAsync(
            ...
            {
                TextDocument = new TextDocumentIdentifier { Uri = "file:///nothing/here.pcross" },
            });
