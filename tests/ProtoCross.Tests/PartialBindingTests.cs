...
public class PartialBindingTests
{
    ...
    public void ATrailingDotBindsItsReceiverAndExposesItsType()
    {
        ...
        Assert.Equal(
            "protocross.examples.InvoiceItem",
    ...
    public void ATrailingDotOnAnEnumTypeExposesTheEnum()
    {
        ...
        Assert.Equal(
            "protocross.tests.TopLevelStatus",
            Assert.IsType<EnumPlType>(awaiting.Receiver.Type).Descriptor.FullName);
        Assert.DoesNotContain(result.Diagnostics, d => d.Code == "PC0037");
    }
    ...
    public void ArgumentsOfACallWithNoMethodNameAreStillChecked()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0037");
    }
    ...
    public void AMethodWithNoNameStillReportsMistakesInItsSignature()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0010");
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0024");
    }
    ...
    public void EachDeclarationBindsAgainstItsOwnParameterList()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0022");
    ...
    public void AMethodRefusedForItsNameStillBindsItsBody()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0023");
    ...
    public void AParameterWithNoNameIsNotDemandedOfATest()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0010");
        Assert.DoesNotContain(result.Diagnostics, d => d.Code == "PC0066");
    }
    ...
    public void AParameterThatWasNamedIsStillDemandedWhenAnotherWasNot()
    {
        ...
        var missing = Assert.Single(result.Diagnostics, d => d.Code == "PC0066");
    ...
    /// </summary>
    [Theory]
    [InlineData("import proto \"nosuch.proto\";\nextend InvoiceItem { fn f() -> int64 { return quantity. } }", "PC0002")]
    [InlineData("extend InvoiceItem { fn f() -> int64 { return quantity. } }", "PC0001")]
    ...
    public void AnImportWithNoPathIsNotAlsoReportedAsNotFound()
    {
        ...
        Assert.Equal("PC0010", Assert.Single(result.Diagnostics).Code);
    }
    ...
    public void AnImportOfAnEmptyPathIsStillReportedAsNotFound()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0002");
    }
    ...
    public void ACallWhoseArgumentHasTheWrongTypeStillKnowsWhatItCalls()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0046");
    ...
    public void ACalleeThatCouldNeverNameAMethodLeavesNoReceiverBehind()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0043");
    ...
    public void ACallOnAValueWithNoMethodsKeepsTheReceiverItWasMadeOn()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0042");
    ...
    public void OneUnresolvableNameProducesOneDiagnostic()
    {
        ...
        Assert.Equal("PC0037", Assert.Single(result.Diagnostics).Code);
    }
    ...
    public void OneUnresolvableNameInsideAFailedCallAlsoProducesOneDiagnostic(string body)
    {
        ...
        Assert.Single(
            result.Diagnostics,
            d => d.Code == "PC0037" && d.Message.Contains("'nope'", StringComparison.Ordinal));
    }
    ...
    /// </summary>
    [Theory]
    [InlineData("extend { }", "PC0010", "PC0021")]
    [InlineData("extend InvoiceItem { fn f() -> int64 { var x: = 1; return 1; } }", "PC0013", "PC0025")]
    [InlineData("extend InvoiceItem { fn f() -> int64 { return name. } }", "PC0010", "PC0041")]
    [InlineData("extend InvoiceItem { fn f() -> int64 { return quantity.(); } }", "PC0010", "PC0044")]
    [InlineData("extend InvoiceItem { fn f() -> bool { return has name.; } }", "PC0010", "PC0041")]
    ...
    public void HalfTypedMethodsDoNotCollideWithEachOther()
    {
        ...
        Assert.DoesNotContain(result.Diagnostics, d => d.Code == "PC0022");
    }
    ...
    public void HalfTypedParametersDoNotCollideWithEachOther()
    {
        ...
        Assert.DoesNotContain(result.Diagnostics, d => d.Code == "PC0026");
    }
    ...
    public void HalfTypedVariablesDoNotCollideWithEachOther()
    {
        ...
        Assert.DoesNotContain(result.Diagnostics, d => d.Code == "PC0029");
    }
