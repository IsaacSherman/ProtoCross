...
public class SchemaCatalogTests
{
    ...
    /// about. <c>notes.txt</c> and <c>reading.pcross</c> are there so "non-.proto files are never
    ...
    public void NonProtoFilesAreNeverOffered()
    {
        ...
        Assert.DoesNotContain("reading.pcross", offered);
    }
