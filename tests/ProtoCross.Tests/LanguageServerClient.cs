...
/// would notice. What runs here is what <c>protocross-server</c> runs; only the streams differ.
/// </para>
/// <para>
...
public sealed class LanguageServerClient : IAsyncDisposable
{
    ...
    public static ClientCapabilities FullCapabilities => new()
    {
        ...
        TextDocument = new TextDocumentClientCapabilities
        {
            ...
            {
                SignatureInformation = new SignatureInformationClientCapabilities
                {
                    ParameterInformation = new ParameterInformationClientCapabilities
                    {
