...
public class CompilationTests
{
    ...
    public void CompilesTheInvoiceExample()
    {
        ...
        Assert.Equal("protocross.examples.InvoiceItem", lineTotal.Receiver.FullName);
        Assert.Equal(ScalarType.Int64Type, lineTotal.ReturnType);

        var totalCents = module.Methods.Single(m => m.Name == "total_cents");
        Assert.Equal("protocross.examples.Invoice", totalCents.Receiver.FullName);
    ...
    public void ReportsUnknownMessage()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0021");
    }
    ...
    public void ReportsMissingReturn()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0027");
    }
    ...
    public void RejectsImplicitNumericConversion()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0048");
    }
    ...
    public void RejectsReturningTheWrongType()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0032");
    }
    ...
    public void RejectsIteratingANonRepeatedField()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0033");
    }
    ...
    public void RejectsCallingAnUndefinedMethod()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0044");
    }
    ...
    public void RequiresOnZeroForIntegerDivision()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0054");
    }
    ...
    public void WarnsWhenOnZeroIsUnreachable()
    {
        ...
        Assert.True(result.Success, string.Join("\n", result.Diagnostics.Select(d => d.ToString())));
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0056");
    }
    ...
    public void RejectsOnZeroWithAMismatchedType()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0055");
    }
    ...
    public void RejectsANonBoolIfCondition()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0071");
    }
    ...
    public void RejectsBreakOutsideALoop()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0072");
    }
    ...
    public void RejectsContinueOutsideALoop()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0073");
    }
