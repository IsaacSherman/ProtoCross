...
public class ConversionTests
{
    ...
    /// target instead would report PC0036 for a value the author explicitly asked to narrow.
    /// </summary>
    [Fact]
    ...
    public void RejectsAConversionThatIsNotBetweenNumericScalars(string body)
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Code == "PC0075");
    }
    ...
    public void NamesBothTypesWhenRejectingAConversion()
    {
        ...
        var diagnostic = Assert.Single(result.Diagnostics, d => d.Code == "PC0075");
    ...
    /// <summary>
    /// An unknown target type is already PC0025's job, and the conversion must not pile a second
    ...
    public void ReportsAnUnknownTargetTypeOnlyOnce()
    {
        ...
        Assert.Single(result.Diagnostics, d => d.Code == "PC0025");
        Assert.DoesNotContain(result.Diagnostics, d => d.Code == "PC0075");
    }
