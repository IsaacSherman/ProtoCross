...
public class WellKnownTypeTests
{
    ...
    {
        var directory = Path.Combine(Path.GetTempPath(), "protocross-bare-protoc", Guid.NewGuid().ToString("N"));
    ...
    public void ExtendingAWellKnownTypeWarnsWithoutRejectingIt()
    {
        ...
        var warning = Assert.Single(result.Diagnostics, d => d.Code == "PC0077");
    ...
    public void ExtendingAnOrdinaryMessageDoesNotWarn()
    {
        ...
        Assert.DoesNotContain(result.Diagnostics, d => d.Code == "PC0077");
    }
