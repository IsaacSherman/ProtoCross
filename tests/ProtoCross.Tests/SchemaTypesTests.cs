...
public class SchemaTypesTests
{
    ...
    private static SchemaTypes TypesOf(string source)
    {
        ...
        Assert.DoesNotContain(result.Diagnostics, diagnostic => diagnostic.Code is "PC0002" or "PC0003");
        return result.Types;
    }
    ...
    {
        var result = Compile(Fixtures);
        var field = result.Types.FindMessage("protocross.tests.Outer")!.FindFieldByName("count");
    ...
    public void AMessageNestedInAnotherMessageIsIndexed()
    {
        ...
        Assert.NotNull(types.FindMessage("protocross.tests.Outer.Inner"));
    ...
    public void AnEnumNestedInAMessageIsIndexed()
    {
        ...
        Assert.NotNull(types.FindEnum("protocross.tests.ambiguous.First.Kind"));
        Assert.NotNull(types.FindEnum("protocross.tests.ambiguous.Second.Kind"));
    }
    ...
    public void ASimpleNameTwoNestedEnumsShareAnswersWithBothOfThem()
    {
        ...
        Assert.Equal(
            ["protocross.tests.ambiguous.First.Kind", "protocross.tests.ambiguous.Second.Kind"],
    ...
    public void ANameNoSchemaDeclaresIsAnsweredWithNothingRatherThanNull()
    {
        ...
        Assert.Null(types.FindMessage("protocross.tests.NoSuchMessage"));
        Assert.Null(types.FindEnum("protocross.tests.NoSuchEnum"));
    ...
    public void ANameDifferingOnlyInCaseIsADifferentName()
    {
        ...
        Assert.NotNull(types.FindMessage("protocross.tests.Outer"));
        Assert.Null(types.FindMessage("protocross.tests.outer"));
