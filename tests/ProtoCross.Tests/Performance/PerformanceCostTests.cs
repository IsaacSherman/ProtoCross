...
/// </para>
/// <para>
/// The milliseconds are measured too, behind <c>PROTOCROSS_BENCH</c>. See
...
public class PerformanceCostTests
{
    ...
    /// <see cref="ProtoCross.LanguageServer.Hosting.DocumentSemantics"/> in the host, and a change
    ...
    /// </para>
    /// <para>
    /// It is also what makes <see cref="ProtoCross.LanguageServer.Hosting.DocumentSemantics.Compilations"/>
    ...
    {
        Assert.True(
            ProtoCross.Binding.DescriptorCache.DefaultCapacity > 0,
        ...
        Assert.True(
            documented.Contains(
                $"cache capacity of {ProtoCross.Binding.DescriptorCache.DefaultCapacity}",
