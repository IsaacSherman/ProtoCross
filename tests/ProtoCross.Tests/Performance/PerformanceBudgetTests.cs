...
/// <remarks>
/// <para>
/// <b>Behind <c>PROTOCROSS_BENCH</c>, and deliberately not in CI.</b> A wall-clock deadline on a
...
public class PerformanceBudgetTests
{
    ...
    public void EveryBudgetedOperationIsWithinItsBudget()
    {
        ...
        {
            Assert.Skip("Set PROTOCROSS_BENCH=1 to measure the budgets. See docs/performance.md.");
        }
        ...
        report.Note($"Descriptor cache capacity is {ProtoCross.Binding.DescriptorCache.DefaultCapacity} entries.");
