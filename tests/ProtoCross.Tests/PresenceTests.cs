...
public class PresenceTests
{
    ...
    public void AMessageFieldReachedThroughAMethodResultSaysHowToGuardIt()
    {
        ...
        var diagnostic = Assert.Single(result.Diagnostics, d => d.Code == "PC0078");
    ...
    {
        AssertCode(CompileBody(body), "PC0079");
    }
    ...
    {
        AssertCode(CompileBody(body), "PC0080");
    }
    ...
    public void AGuardedReadEmitsThePlainAccessorChain()
    {
        ...
        Assert.Contains("return self.inner().deep();", Emit(new CppBackend(), Body, "test.pc.h"), StringComparison.Ordinal);
    }
}
