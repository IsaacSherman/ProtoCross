...
| `PL2001`–`PL2099` | The driver and the configuration file ([10.4](./§10-Numeric%20Semantics.md#104-compile-time-policy)) |
| `PL2100`–`PL2199` | Host configuration: settings, scopes, and precedence ([10.4.1](./§10-Numeric%20Semantics.md#1041-host-configuration)) |
