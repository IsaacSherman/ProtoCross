...
- ~~File extension.~~ Decided: `.protolang` ([5.1](./§5-Source%20Organization.md#51-files)).
...
- ~~Complete scalar type support.~~ Decided: all protobuf scalar spellings map into the supported
  ProtoLang value domains ([8.2](./§8-Type%20System.md#82-protobuf-scalar-mapping)).
- Decimal support.
...
- ~~ProtoLang unit test declaration syntax.~~ Decided: `test` declarations in `.protolang` files
  ([25.3](./§25-Testing%20and%20Conformance%20Vectors.md#253-author-written-protolang-unit-tests)). Separate `.protolangtest` files remain open.
